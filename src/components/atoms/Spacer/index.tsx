...
const Container = styled.div<{ top: number, bottom: number, left: number, right: number }>`
...
const Spacer = ({
  ...
  left = 0,
  right = 0
}: { children: React.ReactNode | React.ReactNode[], top?: number, bottom?: number, left?: number, right?: number }) => (
